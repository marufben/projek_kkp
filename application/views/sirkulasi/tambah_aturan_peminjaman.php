<div class="row">
	<div class="col-md-12">
		<?php $config = array('class'=>'form-horizontal form-bordered', 'id'=>'formAddmenu'); echo form_open('aturan_peminjaman/create', $config);?>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">Tambah Hak Akses</h4>
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-4">
                        <select class='form-control' name="tipe_koleksi" id="tipe_koleksi">
							<?php
								...
								# code...
								echo "<option value='".$value->id."'>".$value->nama_tipe."</option>";
								}
                    ...
                    <div class="col-sm-4">
                        <select class='form-control' name="gmd" id="gmd">
							<?php
								...
								# code...
								echo "<option value='".$value->id."'>".$value->gmd_name."</option>";
								}
							?>
						</select>
                    </div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-1">
						<input type="text" class="form-control" id="jumlah_pinjaman" name='jumlah_pinjaman' placeholder="">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-1">
						<input type="text" class="form-control" id="periode_peminjaman" name='periode_peminjaman' placeholder="">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-1">
						<input type="text" class="form-control" id="kali_perpanjangan" name='kali_perpanjangan' value="0" placeholder="">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" class="form-control" id="denda_harian" name='denda_harian' value="0" placeholder="">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" class="form-control" id="keterlambatan" name='keterlambatan' value="0" placeholder="">
					</div>
				</div>
