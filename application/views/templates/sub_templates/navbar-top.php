                        ...
                        <ul class="dropdown-menu dropdown-messages pull-right">
                            ...
                            <li class="unread">
                                <a href="javascript:;" class="message">
                                    <img class="message-image img-circle" src="<?php echo base_url();?>assets/template2/images/avatars/1.jpg">
                            ...
                            <li class="unread">
                                <a href="javascript:;" class="message">
                                    <img class="message-image img-circle" src="<?php echo base_url();?>assets/template2/images/avatars/3.jpg">
                            ...
                            <li>
                                <a href="javascript:;" class="message">
                                    <img class="message-image img-circle" src="<?php echo base_url();?>assets/template2/images/avatars/8.jpg">
                            ...
                            <li>
                                <a href="javascript:;" class="message">
                                    <img class="message-image img-circle" src="<?php echo base_url();?>assets/template2/images/avatars/7.jpg">
