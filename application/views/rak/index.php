	...
	<div class="col-md-12">
		...
		<div class="panel panel-success panel-clean">
            ...
            <div class="panel-body">
						<a class="btn btn-primary" href="<?php echo base_url();?>rak/create">
						...
						<table id="master-lemari" class="table table-striped dataTable">
							...
							<tbody>
								...
								<tr>
									...
									<td width="20%">
										<!-- <a class="btn" href="<?php echo base_url()."rak/edit/".$value->id;?>">
											<i class="icon-edit"></i>
											Edit
										</a> -->
										<button class="btn btn-danger" onclick="kirimId('<?php echo $value->id;?>','<?php echo $value->no." Rak Ke - ".$value->urutan;?>')" data-target="#hapusModal" data-toggle="modal">
...
function kirimId(id, nama)
{
	...
	$("#hapus").attr("href","<?php echo base_url();?>rak/delete/"+id);
}
</script>