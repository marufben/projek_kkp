						...
						<table id="master-menu" class="table table-striped dataTable">
							...
							<tbody>
								...
								<tr>
									...
									<td width="20%">
										<a class="btn" href="<?php echo base_url()."users/edit/".$value->id;?>">
											<i class="icon-edit"></i>
											Edit
										</a>
										<button class="btn btn-danger" onclick="kirimId('<?php echo $value->id;?>','<?php echo $value->username;?>')" data-target="#hapusModal" data-toggle="modal">
