	...
	<div class="col-md-12">
		...
		<div class="panel panel-success panel-clean">
            ...
            <div class="panel-body">
						<a class="btn btn-primary" href="<?php echo base_url();?>statusizin/create">
						...
						<table id="master-statusizin" class="table table-striped dataTable">
							...
							<tbody>
								...
								<tr>
									...
									<td width="20%">
										<a class="btn" href="<?php echo base_url()."statusizin/edit/".$value->id;?>">
											<i class="icon-edit"></i>
											Edit
										</a>
...
function kirimId(id, nama)
{
	...
	$("#hapus").attr("href","<?php echo base_url();?>statusizin/delete/"+id);
}
</script>